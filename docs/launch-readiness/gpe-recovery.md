...
The [production release record](deployment-20260915.md) and [live results](gpe-recovery-live-results.json) record the completed database/API/worker rollout and actual production verdicts. The evidence above remains the separate local rehearsal. Real payment/mail acceptance and Apple Pay prerequisites are listed in the [owner checklist](owner-acceptance.md).
