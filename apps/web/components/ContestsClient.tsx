...
export default function ContestsClient({ initialContests, initialTab }: { initialContests: ContestListItem[] | null; initialTab: "CPE" | "GPE" }) {
  const t = useT();
  ...
  const {
    ...
    initialData: initialContests ?? undefined,
  });
