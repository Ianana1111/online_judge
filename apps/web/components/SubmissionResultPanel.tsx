...
export default function SubmissionResultPanel({ slug, resultTab }: { slug: string; resultTab: SubmissionResultTab }) {
  ...
  return (
    <div>
      <div className="mb-4">
        {/* Deliberately its own key, not VerdictBadge's short VERDICT_LABEL code ("AC") — this big
            AC-screen heading spells out the literal English word "Accept" in both locales. */}
