...
export const batch1Dictionary: Record<string, string> = {
  ...
  "{n} days solving in a row": "連續 {n} 天都有解題",
  "No login streak yet": "尚無連續登入紀錄",
  "No solve streak yet": "尚無連續解題紀錄",
  "Hover to see your solve streak": "移入查看連續解題",
  "Move away to see your login streak": "移開查看連續登入",
  "Tap to switch streak": "點一下切換紀錄",
  "Continue solving": "繼續解題",
  "Pick up where you left off": "接續上次的題目",
  "current tier": "目前等級",
  "solved": "已解出",
  "rank this week": "本週排名",
  "achievements": "成就",
