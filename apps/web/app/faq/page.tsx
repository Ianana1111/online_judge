...
// `plain` is a plain-text duplicate of `a` (which is JSX, sometimes with embedded links/spans)
// used only for the FAQPage JSON-LD below — schema.org's acceptedAnswer.text needs plain text,
// and reconstructing it by parsing JSX would be far more fragile than just writing it twice.
const SECTIONS: { title: string; items: { q: string; a: React.ReactNode; plain: string }[] }[] = [
  {
    title: "帳號與 Pro 方案",
    items: [
      {
