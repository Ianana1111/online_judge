...
Java reuses maximum-size DP buffers and clears only each case's active area, preventing repeated seven-dimensional cases from accumulating large arrays awaiting collection.
