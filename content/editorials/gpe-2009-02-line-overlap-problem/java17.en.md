...
Turn endpoints into +1/−1 events; between events, overlap count is fixed and contributes choose(active,2) pairs per unit length. Java packs coordinate and event direction into a primitive `long` array to avoid hundreds of thousands of objects.
