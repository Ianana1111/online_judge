...
An empty line denotes the empty set. Apply equality and proper-subset classifications before disjointness; thus two empty sets are equal, and an empty set is a proper subset of a nonempty set.
