...
and deadlines of the treasures. A place i is located at distance d<sub>i</sub> from the leftmost end of the road.
...
A treasure disappears at its deadline. It must be collected at a time strictly less than that deadline; arriving exactly at the deadline is too late. Movement speed is one distance unit per time unit, collection is instantaneous, and the starting position can be chosen freely at time zero.
